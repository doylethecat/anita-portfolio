      ...
      >
        ...
        <motion.div variants={fadeInUp} className="flex justify-between items-center mb-12">
          <button
            ...
            className="group flex items-center gap-3 px-6 py-3 rounded-full transition-all border border-[#589CD0]/10 bg-white/5 hover:bg-white/10"
            style={{ color: "#589CD0" }}
          >
                ...
                {project.tools.map((tool, idx) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="flex items-center gap-2.5 px-4 py-2 rounded-xl text-sm font-medium bg-[#6facdc]/5 border border-[#6facdc]/10 hover:border-primary-glow/50 transition-all cursor-default group/skill"
                    >
                      {Icon && (
                        <Icon 
                          size={16} 
