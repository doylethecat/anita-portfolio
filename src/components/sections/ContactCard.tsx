    ...
    >
        ...
        <AnimatePresence>
          {isActive && (
            ...
            >
              ...
              <motion.div 
                variants={fadeInUp}
                className="group/item relative p-8 rounded-3xl bg-[#F5F4EF]/[0.04] border border-[#F5F4EF]/5 hover:bg-[#F5F4EF]/[0.08] transition-all cursor-pointer flex flex-col justify-between min-h-[160px]"
                onClick={(e) => {
                  e.stopPropagation();
              ...
              >
                <div className="flex justify-between items-start">
                  <div className="w-10 h-10 rounded-xl bg-[#F5F4EF]/5 flex items-center justify-center text-[#F5F4EF]/60">
                    <Phone size={18} />
                  </div>
      ...
      <motion.div layout className="flex justify-between items-center mt-8 relative z-10">
        ...
        <div className="flex items-center gap-4">
          <div className="p-3 rounded-full bg-black/5 border border-[#F5F4EF]/5 text-[#F5F4EF]/40">
