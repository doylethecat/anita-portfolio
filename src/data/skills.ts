...
import {
  ...
  SiJavascript, SiAndroidstudio, SiVite, SiRedux,
  SiExpress, SiBootstrap, SiSocketdotio, SiGithubpages, SiHtml5,
  SiFramer, SiApachesuperset, SiRender, SiMysql,
  SiSwift, SiXcode,
  SiNotebooklm,
  SiGithub,
  SiExpo,
...
import { TbBrandAdobeIllustrator, TbBrandAdobePhotoshop, TbBrandCSharp } from "react-icons/tb";
...
export const SKILLS: SkillType[] = [
  ...
  { name: "Swift", icon: SiSwift, color: "#dc6135ff", category: "Languages" },
  ...
  { name: "Socket.IO", icon: SiSocketdotio, color: "#010101", category: "Backend" },
   { name: "MySQL", icon: SiMysql, color: "#4662afff", category: "Backend" },
  ...
  { name: "Miro", icon: SiMiro, color: "#f4f262ff", category: "Design" },
  { name: "JustInMind", icon: SiDotnet, color: "#f462d0ff", category: "Design" },
  { name: "Adobe Illustrator", icon: TbBrandAdobeIllustrator, color: "#f4ab62ff", category: "Design" },
  { name: "Adobe Photoshop", icon: TbBrandAdobePhotoshop, color: "#3995ebff", category: "Design" },
  ...
  { name: "GitHub", icon: SiGithub, color: "#444a47ff", category: "Tools" },
  ...
  { name: "Superset", icon: SiApachesuperset, color: "#0078D4", category: "Tools" },
  { name: "Render", icon: SiRender, color: "#222222", category: "Tools" },
  { name: "XCode", icon: SiXcode, color: "#3f8df4ff", category: "Tools" },
  { name: "Amazon AWS", icon:SiDotnet , color: "#ffd343ff", category: "Tools" },
  { name: "Expo", icon:SiExpo , color: "#272e37ff", category: "Tools" },
  ...
  { name: "NotebookLM", icon: SiNotebooklm, color: "#271a15ff", category: "AI" },

  
  // Variations for matching in projects (no category to hide from main list)
  { name: ".NET Blazor", icon: SiBlazor, color: "#5C2D91" },
  { name: "CloudFlare R2", icon: SiCloudflare, color: "#e18337ff" },
  { name: "Leaflet", icon: SiLeaflet, color: "#37e16aff" },
